...
FRESULT pf_read (void* buff, uint32_t btr, uint32_t* br);			/* Read data from the open file */
FRESULT pf_write (const void* buff, uint32_t btw, uint32_t* bw);	/* Write data to the open file */
