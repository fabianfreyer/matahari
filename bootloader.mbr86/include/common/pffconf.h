/**
 * \file pffconf.h
 * \brief Petit FatFs - Configuration file
...
/**
 * \defgroup pffconf_func Function Configurations
 * @{
 */

/** Enable pf_read() function */
#define _USE_READ 1

/** Enable pf_opendir() and pf_readdir() function */
#define _USE_DIR 0

/** Enable pf_lseek() function */
#define _USE_LSEEK 0

/** Enable pf_write() function */
#define _USE_WRITE 0
...
/**
 * \defgroup pffconf_locale Locale and Namespace Configurations
 * @{
 */
...
/**
 * \defgroup pffconf_sys System Configurations
 * @{
 */
