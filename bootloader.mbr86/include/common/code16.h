...
#define set_ds(_ds) _define_wrap(asm volatile("movw %0 %%ds" :: "rm"(_ds) :);)
#define set_fs(_fs) _define_wrap(asm volatile("movw %0,%%fs" :: "rm"(_fs) :);)
#define set_gs(_gs) _define_wrap(asm volatile("movw %0,%%gs" :: "rm"(_gs) :);)
